    ...
    <div>
      <Head>
        ...
        <meta
          property="og:title"
          content="plantmatica"
          key="Plantmatica, herbolaria, plantmatica, PlantMatica, plantas, Tucans Software, remedios medicinales, tucans software, herbolaria mexico, medicina alternativa, cecyt 9"
        />
          ...
          <div className={styles.container_1}>
            ...
            <center>
              <div className={styles.container_3}>
                <h3>
                  {`Bienvenido a PlantMatica, un sitio ideal para conocer más sobre herbolaria en México.`}
                  <br />
                  <br />
                  ...
                  <div className={styles.tb_info}>
                    ...
                    <div>
                      <p className={styles.p_info}>
                        Podrás formas parte de nuestra comunidad, conocer más sobre herbolaria en
                        México, consultar informacion acerca de la herbolaria, compartir tus
